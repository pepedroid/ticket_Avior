<?php if(isset($_SESSION['nombre']) && isset($_SESSION['tipo'])){
        ...
        if(isset($_POST['fecha_ticket'])){
          ...
          $fecha_ticket = date("d/m/Y h:i:s");//Añadimos la hora al ticket
          //$nombre_ticket=  MysqlQuery::RequestPost('name_ticket');
         // $nombre_ticket=  $_SESSION["nombre"];
           $nombre_ticket= $_SESSION['nombre_completo']; //Guardamos el nombre del empleado
                ...
                <div class="panel-body">
                  <div class="row">
                    <div class="col-sm-4 text-center">
                      ...
                      <p class="text-primary text-justify">Por favor llene todos los datos de este formulario para abrir su ticket. El <strong>Ticket ID</strong> será enviado al administrador de TI para darle seguimiento y solucion.</p>
                    </div>
                    <div class="col-sm-8">
                      <form class="form-horizontal" role="form" action="" method="POST">
                        ...
                        <div class="form-group">
                          <label  class="col-sm-2 control-label">Problema/Falla</label>
                          <div class="col-sm-10">
